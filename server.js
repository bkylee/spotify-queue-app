...
async function refreshAccessToken() {
  if (!tokenStore.refresh_token) throw new Error('No refresh token stored. Please authorize first.');
...
app.get('/callback', async (req, res) => {
  ...
  try {
    ...
    console.log('💾 Save this refresh token to your .env as SPOTIFY_REFRESH_TOKEN:');
